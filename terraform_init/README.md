...
- `ci_user_name`: Name of the IAM user for Terraform CI/CD
...
- A near ready-to-use backend configuration block

To access the created credentials that were output by terraform, you can use the following command:
